...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        it('should have at a single .entry element', function(done) {
            let container = document.querySelector('.feed');
                expect(container.querySelector('.entry-link')).toBeTruthy();
                done();
        });
    });
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                startState = document.querySelector('.feed').innerHTML;
                loadFeed(1, function() {
                    endState = document.querySelector('.feed').innerHTML;
                    done();
                })
            })
        });
